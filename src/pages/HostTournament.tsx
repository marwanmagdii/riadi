...
export default function HostTournament() {
  ...
  const handleTournamentSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault(); 
    
    const form = e.currentTarget;
    const formData = new FormData(form);
    
    // CRITICAL: Google Forms expects application/x-www-form-urlencoded data
    ...
    try {
      // Send the data silently using fetch with no-cors
      ...
      {isSubmitted && (
        <div className="fixed inset-0 bg-black/90 z-[100] flex flex-col items-center justify-center text-center p-8 backdrop-blur-sm">
          <div className="bg-[#111814] border border-white/10 p-10 rounded-3xl max-w-md w-full shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-white/70 text-lg">Our team will contact you soon to help organize your tournament.</p>
          </div>
        </div>
      )}
      ...
      <section className="pt-32 pb-24 px-6 md:px-12 lg:px-24 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">Host a Tournament</h1>
            <p className="text-white/60 text-lg">
              Fill out the form below with your tournament details, and our team will get back to you to help organize the perfect event.
            </p>
          </div>

          <div className="bg-[#111814] border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
            <form 
              action="https://docs.google.com/forms/d/e/1FAIpQLSeUe1SCr0GH-B3sdU1zSambsN0iMH20pgspQpAHv9_qJcTwkg/formResponse" 
              method="POST"
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-white/70">Tournament Name</label>
                  <input 
                    type="text" 
                    name="entry.1348385853"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-white/70">Expected Number of Teams</label>
                  <select 
                    name="entry.1133520398"
                    value={expectedTeams}
                  ...
                  >
                    ...
                    <option value="4-8 Teams">4-8 Teams</option>
                    <option value="8-16 Teams">8-16 Teams</option>
                    <option value="16-32 Teams">16-32 Teams</option>
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  placeholder="Tell us about the dates, preferred location, format, or any special requirements..."
                  required
                ></textarea>
              </div>
