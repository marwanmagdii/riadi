    ...
    <div className="min-h-screen bg-[#0A0E0C] text-white selection:bg-secondary selection:text-white flex flex-col relative">
      ...
      <div className="flex-1 pt-24 md:pt-32 px-6 md:px-12 lg:px-24 max-w-4xl mx-auto w-full pb-24">
        ...
        <div className="prose prose-invert max-w-none text-white/80 space-y-6">
          ...
          <p>Welcome to Riadi ("we," "our," or "us"). We are committed to protecting your privacy and ensuring you have a positive experience on our platform. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you visit our website, use our mobile application, or interact with our services (collectively, the "Services").</p>
          <p>Please read this Privacy Policy carefully. By accessing or using our Services, you agree to be bound by the terms and conditions described herein. If you do not agree with the terms of this Privacy Policy, please do not access the site or use our Services.</p>

          <h2 className="text-2xl font-bold text-[#34d399] mt-8 mb-4">1. Information We Collect</h2>
          ...
          <h2 className="text-2xl font-bold text-[#34d399] mt-8 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-bold text-[#34d399] mt-8 mb-4">3. Sharing of Information</h2>
          ...
          <h2 className="text-2xl font-bold text-[#34d399] mt-8 mb-4">4. Data Security</h2>
          ...
          <h2 className="text-2xl font-bold text-[#34d399] mt-8 mb-4">5. Your Privacy Rights and Choices</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-[#34d399] mt-8 mb-4">6. Children's Privacy</h2>
          ...
          <h2 className="text-2xl font-bold text-[#34d399] mt-8 mb-4">7. Changes to This Privacy Policy</h2>
          ...
          <h2 className="text-2xl font-bold text-[#34d399] mt-8 mb-4">8. Contact Us</h2>
          <p>If you have any questions or concerns about this Privacy Policy or our data practices, please contact us at:</p>
          <div className="bg-white/5 border border-white/10 rounded-lg p-6 mt-4">
              <p className="text-white font-medium mb-2">Riadi Sports</p>
              <p className="mb-2">Email: <a href="mailto:contact@riadiapp.com" className="text-primary hover:underline">contact@riadiapp.com</a></p>
